        ...
        <div className="mb-16 text-center">
          <Reveal>
            ...
            >
              ...
              <span className="text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(to right, #00ff85, #02efff)", WebkitBackgroundClip: "text" }}>Fantasy Premier League.</span>
              <br />
