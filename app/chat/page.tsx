...
export default function ChatPage() {
  ...
  const [userInitials, setUserInitials] = useState("CF")
  ...
  return (
    <div className="bg-black text-white overflow-hidden chat-root" style={{ height: '100dvh' }}>
      <style>{`
        .chat-root ::-webkit-scrollbar { width: 4px; height: 4px; }
        .chat-root ::-webkit-scrollbar-track { background: transparent; }
        .chat-root ::-webkit-scrollbar-thumb { background: rgba(0,255,200,0.2); border-radius: 99px; }
        .chat-root ::-webkit-scrollbar-thumb:hover { background: rgba(0,255,200,0.4); }
              ...
              <div className="shrink-0 border-t border-white/[0.07] bg-black/90 md:bg-black/20 backdrop-blur-xl md:backdrop-blur-none p-4">
                ...
                {voicePrefsHydrated ? (
                  <ChatVoiceControls
                    ...
                    onUseVoiceboxChange={handleUseVoiceboxChange}
