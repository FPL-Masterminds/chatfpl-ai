    ...
    <div className="flex min-h-screen flex-col">
        ...
        <div className="container relative mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mx-auto max-w-3xl text-lg font-semibold text-white">
              Watch how ChatFPL AI analyzes premium FPL assets with live data, form, fixtures, and value-for-money insights
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="mb-8 text-center">
            ...
            <p className="text-lg font-semibold" style={{ color: '#4B5563' }}>
              This video demonstrates how ChatFPL AI evaluates premium FPL assets like Haaland
            </p>
          </div>
          ...
          <div className="mx-auto max-w-md">
            ...
            >
              <iframe 
                ...
                src="https://www.youtube.com/embed/pPrI00NoEWo" 
                title="ChatFPL AI Demo - Is Erling Haaland Worth His Price?"
                frameBorder="0" 
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">ChatFPL AI understands you want cost-benefit evaluation</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="mt-1 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-[#00FF87]">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">The AI knows to compare price against returns and alternatives</p>
                  </div>
                </div>
              </div>
            </CardContent>
      ...
      <section className="border-b bg-white px-4 py-16">
        <div className="container mx-auto max-w-5xl">
            ...
            <Card className="border-gray-200 bg-white shadow-sm">
              ...
              <CardContent className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-gray-900">£14.9m</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-gray-900">944</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Form:</span>
                  <span className="font-semibold text-gray-900">6.3</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Points per Game:</span>
                  <span className="font-semibold text-gray-900">9.3</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Ownership:</span>
                  <span className="font-semibold text-gray-900">70.8%</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 bg-white shadow-sm">
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-gray-900">444</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">ICT Index:</span>
                  <span className="font-semibold text-gray-900">92.3</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 bg-white shadow-sm">
              ...
              <CardContent className="space-y-2 text-sm">
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">vs Newcastle (A)</span>
                  <Badge className="bg-[#2E0032] text-white">Difficulty 4</Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">vs Leeds United (H)</span>
                  <Badge variant="default" className="bg-[#00FF87] text-gray-900">Difficulty 2</Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">vs Fulham (A)</span>
                  <Badge variant="default" className="bg-[#00FF87] text-gray-900">Difficulty 3</Badge>
                </div>
                <div className="flex items-center justify-between">
          ...
          <Card className="mx-auto mt-6 max-w-3xl border-gray-200 bg-white shadow-sm">
            ...
            <CardContent>
              <div className="flex items-center justify-around text-center">
                <div>
                  <p className="text-3xl font-bold text-[#00FF87]">74,481</p>
                  <p className="text-sm text-gray-600">Transfers In</p>
                </div>
                <div className="h-12 w-px bg-gray-300"></div>
                <div>
                  <p className="text-3xl font-bold text-[#2E0032]">6,048</p>
                  <p className="text-sm text-gray-600">Transfers Out</p>
                </div>
              </div>
              <p className="mt-4 text-center text-sm text-gray-600">
                Managers are actively buying him - price rises are likely
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="mx-auto mt-6 max-w-3xl border-gray-200 bg-white shadow-sm">
            <CardHeader>
              <CardTitle className="text-gray-900">Value Assessment</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600">
                Haaland is worth his price for most managers who can afford the hit to squad balance. 
                His elite PPG (9.3), consistent returns, and captaincy value justify the £14.9m cost. 
                However, if budget is tight or you need flexibility for multiple transfers, consider 
                mid-priced forward options like João Pedro (£7.5m) or Mateta (£8.1m).
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Card className="border-gray-200 bg-white shadow-sm">
              ...
              <CardContent className="text-gray-600">
                Advanced language models interpret your question, understand context (price evaluation, 
                value analysis), and structure a comprehensive response instantly.
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 bg-white shadow-sm">
              ...
              <CardContent className="text-gray-600">
                The AI doesn't just list numbers - it evaluates cost vs returns, ownership impact, 
                captaincy value, and provides alternative options at different price points.
              </CardContent>
            </Card>
          </div>
