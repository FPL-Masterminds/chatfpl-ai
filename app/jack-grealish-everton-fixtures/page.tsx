...
export default function JackGrealishFixturesPage() {
  return (
    <div className="flex min-h-screen flex-col">
        ...
        <div className="container relative mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mx-auto max-w-3xl text-lg font-semibold text-white">
              Watch how ChatFPL AI analyzes fixture difficulty, form, and alternatives to help you make smarter FPL decisions
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="mb-8 text-center">
            ...
            <p className="text-lg font-semibold" style={{ color: '#4B5563' }}>
              This video demonstrates how ChatFPL AI evaluates fixture-based transfer decisions
            </p>
          </div>
          ...
          <div className="mx-auto max-w-md">
            ...
            >
              <iframe 
                ...
                src="https://www.youtube.com/embed/tU2_AWaMWGw" 
                title="ChatFPL AI Demo - Jack Grealish Fixture Analysis"
                frameBorder="0" 
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">Fixture-based analysis</p>
                    <p className="text-sm text-gray-600">ChatFPL AI understands you want fixture difficulty evaluation</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="mt-1 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-[#00FF87]">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">The AI knows to evaluate form, fixtures, and alternative options</p>
                  </div>
                </div>
              </div>
            </CardContent>
      ...
      <section className="border-b bg-white px-4 py-16">
        <div className="container mx-auto max-w-5xl">
            ...
            <Card className="border-gray-200 bg-white shadow-sm">
              ...
              <CardContent className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-gray-900">£6.8m</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-gray-900">2.0</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-gray-900">16.1%</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 bg-white shadow-sm">
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-gray-900">317.5</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">ICT Index:</span>
                  <span className="font-semibold text-gray-900">80.7</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 bg-white shadow-sm">
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-green-600">100% Fit</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 bg-white shadow-sm">
              ...
              <CardContent className="space-y-2 text-sm">
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">vs Man Utd (A)</span>
                  <Badge variant="default" className="bg-yellow-500 text-gray-900">Difficulty 3</Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">vs Newcastle (H)</span>
                  <Badge variant="default" className="bg-yellow-500 text-gray-900">Difficulty 3</Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">vs Bournemouth (A)</span>
                  <Badge className="bg-[#2E0032] text-white">Difficulty 4</Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">vs Chelsea (H)</span>
                  <Badge variant="default" className="bg-yellow-500 text-gray-900">Difficulty 3</Badge>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="mx-auto mt-6 max-w-3xl border-gray-200 bg-white shadow-sm">
            ...
            <CardContent>
              <div className="flex items-center justify-around text-center">
                <div>
                  <p className="text-3xl font-bold text-[#00FF87]">14,929</p>
                  <p className="text-sm text-gray-600">Transfers In</p>
                </div>
                <div className="h-12 w-px bg-gray-300"></div>
                <div>
                  <p className="text-3xl font-bold text-[#2E0032]">115,436</p>
                  <p className="text-sm text-gray-600">Transfers Out</p>
                </div>
              </div>
              <p className="mt-4 text-center text-sm text-gray-600">
                Managers are actively selling him this week - price fall risk
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="mx-auto mt-6 max-w-3xl border-gray-200 bg-white shadow-sm">
            <CardHeader>
              <CardTitle className="text-gray-900">Recommendation</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600">
                Grealish isn't a priority transfer right now. With mixed fixtures (no easy matches), low current form (2.0), 
                and modest expected points (2.0), he's a medium-risk pick. If you already own him, keep for Everton coverage. 
                If buying, consider higher-form alternatives like Iliman Ndiaye (£6.6m, better xP) or budget differentials 
                from other teams with easier fixtures.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Card className="border-gray-200 bg-white shadow-sm">
              ...
              <CardContent className="text-gray-600">
                Advanced language models interpret your question, understand context (fixtures, form, alternatives), 
                and structure a comprehensive response instantly.
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 bg-white shadow-sm">
              ...
              <CardContent className="text-gray-600">
                The AI doesn't just list numbers - it evaluates fixture difficulty, transfer trends, 
                and provides alternative player options with budget comparisons.
              </CardContent>
            </Card>
          </div>
