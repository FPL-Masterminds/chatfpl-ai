        ...
        {alts
          ...
          .map((alt) => (
            ...
            >
              ...
              <p className="text-sm font-bold text-white leading-tight group-hover:text-transparent group-hover:bg-clip-text transition-all" style={{ WebkitBackgroundClip: "text" }}>
                {alt.name}
              </p>
  ...
  return (
    <div className="fpl-player-root flex min-h-screen flex-col bg-black">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center px-4 pt-10 pb-16 bg-black">
        ...
        {/* Differential alternatives (shown when player is not a strong diff) */}
