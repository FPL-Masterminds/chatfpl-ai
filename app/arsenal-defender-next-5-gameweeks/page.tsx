...
export const metadata = {
  title: "Which Arsenal defender should I bring in for the next 5 gameweeks? | ChatFPL AI",
  description: "Find the best Arsenal defender to bring into your FPL team. ChatFPL AI compares defensive stats, fixtures, and clean sheet potential to help you choose wisely.",
}

export default function ArsenalDefenderPage() {
  return (
          ...
          <Card className="border-[#00FF87] bg-white shadow-lg">
            ...
            <CardContent className="space-y-6">
              ...
              <p className="text-gray-600">
                This page will feature a detailed comparison of Arsenal defenders, including fixture difficulty, clean sheet probability, bonus points potential, and underlying defensive statistics.
              </p>
              <div className="pt-6">
